@php
    $navSections = [
        ...
        'Transactions' => [
            ['id' => 'debit', 'label' => 'Debit', 'route' => null, 'icon' => 'down'],
            ['id' => 'credit', 'label' => 'Credit', 'route' => null, 'icon' => 'up'],
            ['id' => 'transfers', 'label' => 'Transfers', 'route' => null, 'icon' => 'scale'],
        ],
        'Reports' => [
            ['id' => 'monthlySpend', 'label' => 'Monthly Spend', 'route' => null, 'icon' => 'calendar'],
            ['id' => 'settlement', 'label' => 'Summary & Settlement', 'route' => null, 'icon' => 'scale'],
            ['id' => 'purchases', 'label' => 'Purchases', 'route' => null, 'icon' => 'down'],
            ['id' => 'sales', 'label' => 'Sales', 'route' => null, 'icon' => 'trend'],
        ],
        'Finance' => [
            ['id' => 'banking', 'label' => 'Banking', 'route' => null, 'icon' => 'bank'],
            ['id' => 'entityLedgers', 'label' => 'Ledger Book', 'route' => null, 'icon' => 'history'],
            ['id' => 'historicalAlam', 'label' => 'Historical Alam Expenses', 'route' => null, 'icon' => 'history'],
        ],
    ];
            ...
            <nav class="sb-nav">
                @foreach ($navSections as $section => $items)
                    ...
                    @foreach ($items as $item)
                        ...
                        @else
                            <div class="nav-item nav-item-disabled" title="Coming in Phase 3+">
                                <x-hex.icon :name="$item['icon']" />
                                <span>{{ $item['label'] }}</span>
                            </div>
                        @endif
